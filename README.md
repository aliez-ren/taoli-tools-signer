...
Example file: [example.keychain.toml](example.keychain.toml) (DO NOT use the mnemonic in the example file or your assets may lose.)
...
3. In this case, `Signer URL` is `https://taoli-tools-signer.example.workers.dev/simple-name` and `Signer Secret` is `your api secret`
